...
export const POINTS_PER_OCCURRENCE: Record<FindingType, number> = {
  EMAIL: 5,
  PHONE: 5,
  BANK_ACCOUNT: 30,
  CREDIT_CARD: 40,
...
export const MAX_COUNTED_OCCURRENCES: Record<FindingType, number> = {
  EMAIL: 10,
  PHONE: 10,
  BANK_ACCOUNT: 5,
  CREDIT_CARD: 5,
...
export const FORCE_RESTRICTED_TYPES: FindingType[] = ["API_KEY", "PASSWORD", "ACCESS_TOKEN"];
...
export const LARGE_VOLUME_PII_THRESHOLD = 40;
