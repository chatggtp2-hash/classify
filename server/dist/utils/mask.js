...
exports.maskDigitsKeepLast = maskDigitsKeepLast;
exports.maskPan = maskPan;
exports.maskEmail = maskEmail;
exports.maskGeneric = maskGeneric;
exports.maskSecretAssignment = maskSecretAssignment;
...
function maskPan(value) {
    ...
    if (value.length !== 10)
        return "X".repeat(Math.max(value.length - 2, 0)) + value.slice(-2);
